from model import keras_lstm, keras_gru_bidirectional
import numpy as np
...
gpu_model_keras = keras_gru_bidirectional(data_dim=dat_dim,timesteps=seq_length,gpu=True)
cpu_model_keras = keras_gru_bidirectional(data_dim=dat_dim,timesteps=seq_length,gpu=False)
